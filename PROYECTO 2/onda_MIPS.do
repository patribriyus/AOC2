...
add wave -noupdate /testbench/uut/cont_ciclos/int_count
add wave -noupdate /testbench/uut/cont_paradas_control/int_count
add wave -noupdate /testbench/uut/cont_paradas_datos/int_count
add wave -noupdate /testbench/uut/cont_paradas_memoria/int_count
add wave -noupdate /testbench/uut/cont_mem_reads/int_count
add wave -noupdate /testbench/uut/cont_mem_writes/int_count
...
add wave -noupdate -expand -group memoria /testbench/uut/Mem_D/ADDR
add wave -noupdate -expand -group memoria /testbench/uut/Mem_D/Din
add wave -noupdate -expand -group memoria /testbench/uut/Mem_D/WE
add wave -noupdate -expand -group memoria /testbench/uut/Mem_D/RE
add wave -noupdate -expand -group memoria /testbench/uut/Mem_D/Dout
...
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/clk
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/reset
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/PC4
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/branch_address_out
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/prediction_out
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/PC4_ID
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/prediction_in
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/branch_address_in
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/update
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/valid
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/prediction
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/tag
add wave -noupdate -group b_predictor /testbench/uut/b_predictor/address
add wave -noupdate -expand -group Predictor -color Salmon /testbench/uut/update_predictor
add wave -noupdate -expand -group Predictor /testbench/uut/predictor_error
add wave -noupdate -expand -group Predictor /testbench/uut/address_error
add wave -noupdate -expand -group Predictor /testbench/uut/decission_error
add wave -noupdate -expand -group Predictor /testbench/uut/PC_in
